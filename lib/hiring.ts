...
export const DEFAULT_PIPELINE_STAGES: DefaultStageDef[] = [
  ...
  { name: "Enviados a Empresa", category: "submitted", color: "#3b82f6", client_portal_visible: true },
  { name: "Entrevistas con Empresa", category: "interview", color: "#14b8a6", client_portal_visible: true },
